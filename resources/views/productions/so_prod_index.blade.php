...
<div class="title">
  <div class="widget-header widget-header-small">
    <font size="3" color="blue"><b>Sales Order To Production List </b></font>
...
<div class="widget-body">
  ...
  <form action="{{route('sales.prod.index')}}" method="post">
  {{ csrf_field() }}
   <div class="row"> 
        <div class="col-md-2">
          ...
          @foreach($rows as $row)  
            @if ($order_no == '' || $row->so_order_no != $order_no)
              <tr> 
                ...
                <td align="right"><a href="{{ route('sales.order.prod.pdf',['id'=>$row->id, 'tag'=>'JP']) }}" class="btn btn-xs btn-info" title="Invoice" target="_blank">Print SO</a></td>
              </tr> 
            @endif
            <tr>
