...
<div class="title">
  <div class="widget-header widget-header-small">
    <font size="3" color="blue"><b>Sales Order To Jute Production List</b></font>
    <div class="widget-toolbar">
        <a href="{{route('sales.jute.prod.index')}}" class="blue"><i class="fa fa-list"></i> List</a>
    </div>
  </div>
</div></legend>
...
<div class="widget-body">
  ...
  <form action="{{route('sales.jute.prod.index')}}" method="post">
  {{ csrf_field() }}
   <div class="row"> 
        <div class="col-md-2">
...
<br/>
<form id="confirm_Form" action="{{route('sales.jute.prod.confirmed')}}" method="post">
  <div class="row">
    <div class="col-md-12">
      @csrf
      <table class="table table-striped table-data table-view">
        <thead class="thead-blue">
          ...
          <th class="text-center" scope="col">SO<br/>Qty(Pcs)</th> 
          <th class="text-center" scope="col">Bal<br/>Qty(Pcs)</th> 
        ...
        <tbody>
          ...
          @foreach($rows as $row)  
              ...
              <tr> 
                ...
                <td>{{ date('d-m-Y',strtotime($row->so_req_del_date)) }}</td>
                 <td colspan="10" align="right">&nbsp;</td>
                  <td align="right"><a href="{{ route('sales.order.prod.pdf', ['id'=>$row->id, 'tag'=>'J']) }}" class="btn btn-xs btn-info" title="Invoice" target="_blank">Print SO</a>
            ...
            <td>{{ $row->so_item_pcs }}</td>  
            <td align="center"><input type="text" data-type="ActualQty" name="ActualQty[]" id="ActualQty_{{$i}}" value="{{ $row->so_item_pcs - $row->so_order_con_qty }}" 
