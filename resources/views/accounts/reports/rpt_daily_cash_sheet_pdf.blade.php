            ...
            <div class="col-md-12">
              <table>
                <thead>
                  ...
                  <tr><th align="center" colspan="6"><b>Daily Cash Statement</b></th></tr>
                  <tr><th align="center" colspan="6"><font size="3"><b>Date:&nbsp;{{ date('d-m-Y', strtotime($fromdate)) }}</b><font></th></tr> 
                </thead>
              </table>
            </div>
          </div>
            ...
            <p>
              <div class="row justify-content-center">
                ...
                <table class="table table-bordered" border="1">
                  <tr>
                   ...
                   <td width="15%" align="center"><b>Head&nbsp;of&nbsp;Accounts</b></td>
             ...
             @endforeach
               <tr>
                ...
                <?php if($comp_name == 'Jist Industrial Co. Ltd.') {
                    $B = $balance - $Total_AMT;
                    $C = $Total_AMT + $B;
                ?>
                <tr>
                ...
                <tr>
                    <td colspan="4" align="right"><b>Balance as per cash book:</b></td>
              ...
              <?php } ?>
               ...
               <tr>
                 ...
                 <td style="border-left:1px solid white; border-right:1px solid white;
                 border-left:1px solid white;" colspan="5">&nbsp;</td></tr>
