      ...
      <table>
        <thead>
          <thead>
              ...
              <tr><th align="center" colspan="8"><font size="2"><b>Control Wise Subsidiary Ledger Balance</b><font></th></tr>
              <tr><th align="left" colspan="4"><b>{{request()->get('acc_Ledger')}}</b></th><th align="right" colspan="4"><font size="3"><b>Date Range:&nbsp;{{ date('d/m/Y', strtotime($fromdate)) }} to {{ date('d/m/Y', strtotime($todate)) }}</b><font></th></tr>
          </thead>
          <tr>
