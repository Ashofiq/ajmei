                ...
                <header>
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td align="center" valign="top" style="width:25%; "><p style="font-size: 20px; text-align: center; font-weight: bold">Payment Voucher</p>
                            <td valign="top" style="width:25%; "></td>
                        </tr>
                    ...
                    <table width="100%" style="font-family: serif; margin-top:-10px;; font-size: 25px" cellpadding="10">
                        <tr>
                            <td width="35%">
                                ...
                                <b>PV. q NO:</b> <span>{{ $rows_m[0]->trans_type }}-{{ $rows_m[0]->voucher_no }} </span>
                            </td>
