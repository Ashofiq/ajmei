    ...
    <main class="columns">
        <div class="inner-container">
            ...
            <section class=""  style="#ccc ;padding: 5px">
                ...
                <div>
                    <table width="100%" cellpadding="10" style="font-family: serif; margin-top:-10px;; font-size: 16px">
                        <tr>
                            <!-- <td width="35%">
                            ...
                            <?php 
                                $method = '';
                                if ($rows_m[0]->trans_type == 'CP') {
                                    $method = 'CASH';
                                }else if($rows_m[0]->trans_type == 'BP'){
                                    $method = "BANK";
                                }else if($rows_m[0]->trans_type == 'CR'){
                                    $method = 'CASH';
                                }else if($rows_m[0]->trans_type == 'BR'){
                                    $method = "BANK";
                                }
                            ?>

                            <td width="35%">
                                <b>Payment Method :</b> <span> <?php echo $method; ?> </span><br>
                                <b>Payment Details :</b> <span> <?php echo $bank; ?> </span>
                            </td>
                            ...
                            <td width="35%" >
                                <b>MR. NO :</b> <span>{{ $rows_m[0]->trans_type }}-{{ $rows_m[0]->voucher_no }} </span><br>
                    ...
                    <table width="100%" cellpadding=""  style="font-family: serif; margin-left: 10px; margin-top:10px;; font-size: 16px">
                        
                        <tr>
                            <td width="35%">
                                <b>Received with thanks from </b> <br>
                            </td>
                            <td width="1%">:</td>
                            <td width="64%"> {{ $head }} -- <?php echo 'AJC-000'.$slNo; ?></td>
                        </tr>
                        ...
                        <tr>
                            <td width="35%"><b>Narration </b></td>
                            <td width="1%">:</td>
                            <td width="64%"> {{ $rows_m[0]->t_narration }} </td>
                        </tr>

                        <tr>
                            <td width="35%"><b>Payment By </b></td>
                            <td width="1%">:</td>
                            <td width="64%"> <b><?php echo $method; ?> </b></td>
                        </tr>
                        
                        <tr>
                            <td width="35%"><b>Amount </b></td>
                            <td width="1%">:</td>
                            <td width="64%"> <b>BDT <span style="border: 1px solid black">{{ number_format($t_d_amount, 2) }}</span> </b></td>
                        </tr>

                        <tr>
                            <td width="35%"><b>In Word </b></td>
                            <td width="1%">:</td>
                            <td width="64%">{{ Helper::convert_number_to_words($t_d_amount) }} Only.</td>
                        </tr>

                        <!-- <tr>
                            <td width="35%">
                                <b>Received with thanks from :</b> {{ $head }} -- <?php echo 'AJC-000'.$slNo; ?><br>
                                <b>Address &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    :</b> <span style="padding-right: 40px">    </span><br>
                                <b>Narration &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    :</b>  {{ $rows_m[0]->t_narration }}<br>
                                <b>Payment By &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    : <?php echo $method; ?></b><br>
                                <b> Amount &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    :</b> BDT <span style="border: 1px solid black">{{ number_format($t_d_amount, 2) }}</span><br>
                                <b>In Word &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    :</b> {{ Helper::convert_number_to_words($t_d_amount) }} Only.
                    ...
                    <!-- <table width="100%" style="font-family: serif; margin-top:-10px;; font-size: 16px" cellpadding="10">
                    ...
                    <table width="100%" style="font-family: serif; margin-top:-10px; font-size: 18px" cellpadding="10">
                        <tr>
                            ...
                            <td width="35%">
                                <span style="text-decoration: overline;">Customer's Signature </span>
                            </td>
                            ...
                            <td width="30%" align="right">
                                <span style="text-decoration: overline;">Receiver</span>
                        ...
                        <tr >
                            <td width="35%">
                                <span style="font-size:70%">Print Date : {{ date('d/m/Y H:s') }}</span>
                            </td>

                            <td width="30%">
                                <span style="font-size:70%">Printed By ({{ Auth::user()->name }})</span>
                            </td>
