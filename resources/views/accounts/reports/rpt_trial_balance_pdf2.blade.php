        ...
        <thead>
          <thead>
            <tr><th align="center" width="100%" colspan="8"><font size="6"><b>{{$comp_name}}</b><font></th></tr>
              <tr><th align="center" colspan="8"><font size="2"><b>Trial Balance</b><font></th></tr>
              <tr><th align="left" colspan="4"><b>{{request()->get('acc_Ledger')}}</b></th>
              <th align="right" colspan="3"><font size="3"><b>Date Range:&nbsp;{{ date('d/m/Y', strtotime($fromdate)) }} to {{ date('d/m/Y', strtotime($todate)) }}</b><font></th></tr>
          </thead>
          <tr>
