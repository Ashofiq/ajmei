            ...
            <div class="col-md-12">
              <table border="0" cellspacing="0" cellpadding="0">
                <tr><td width="14%" valign="top" align="left"><img src="dist/img/jist_logo.jpeg"/></td>
                  ...
                  <td valign="middle" align="right"><font size="4"><b>Customer Summary Report <br/>Date:
              ...
              <div class="row justify-content-center">
                ...
                <table class="table table-bordered" border="1">
                  <tr>
                    ...
                    <td align="left" colspan="3"><b>{{$cust_data->cust_name}}</b></td>
                </tr>
                <tr>
                    <td align="left"><b>Address:</b></td>
                    <td align="left" colspan="3"><b>{{$cust_data->cust_add1}} {{$cust_data->cust_add2}}</b></td>
                 </tr>
                 <tr>
