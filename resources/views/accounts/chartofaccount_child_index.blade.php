...
<div class="title"><legend>Chart Of Accounts Sub Head</legend></div>
<div class="container">
...
<form action="{{route('chartofacc.acchead.child.store')}}" method="POST">
{{ csrf_field() }}
    ...
    <div class="col-md-10">
      <div class="container-fluid">
        <table  id="dynamic_field"  class="table table-striped table-report table-sm">
            <tr>
              <td>
                <b>{{$chartofdata->acc_code}} ::: {{$origin}}</b>
              </td>
          ...
          <thead class="thead-dark">
               ...
               <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <form  method="post" action="{{ url('/chartofacc/child/destroy') }}" class="delete_form">
                      {{ csrf_field() }}
...
<script type="text/javascript">
    $(document).ready(function(){
      ...
      $('.edit').on('click',function() {
          ...
          $('#editForm').attr('action','{{route("chartofacc.acchead.child.update")}}');
