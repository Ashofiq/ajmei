              ...
              <div class="row justify-content-center">
                ...
                <table class="table table-bordered" border="1">
                 <tr>
                   ...
                   @if($rows_m->po_type != '0')
                    <td align="center"><b>Price (BDT)</b></td>
                   @endif
                   <td align="center"><b>Total ({{ $rows_m->po_m_curr }})</b></td>
                   @if($rows_m->po_type != '0')
                    <td align="center"><b>Total (BDT)</b></td>
                   @endif
                  ...
                  <?php
                    ...
                    $po_amount_bdt = $po_amount*$rows_m->po_m_curr_rate;
                  ?>
                  <tr>
                    ...
                    @if($rows_m->po_type != '0')
                      <td align="right">{{ number_format($p_details->po_item_price*$rows_m->po_m_curr_rate, 2) }}</td>
                    @endif
                  ...
                  <tr>
                    ...
                    @if($rows_m->po_type != '0')
                      <td align="right"><b>{{ number_format($rows_m->po_total_amount*$rows_m->po_m_curr_rate, 2) }}</b></td>
                    @endif
                      <td align="right">&nbsp;</td>
                  </tr>
                </table>
