  ...
  <div class="title">
    <div  style="background-color:#e0e0e0;" class="widget-header widget-header-small">
      <h6 class="widget-title smaller">
        <font size="3" color="blue"><b>Department & Section Wise Listing of Employees</b></font>
      </h6>
    </div>
  </div>
  <div class="container">
    <form id='myform' action="{{route('get.dept.sec.list')}}" id="acc_form" method="post">
      {{ csrf_field() }}
            ...
            <tbody>
              ...
              @foreach($rows as $row) 
                ...
                <tr>
                  ...
                  <th class="text-center">Present Salary</th> 
                </tr>
                <?php } ?>
              </thead>
              ...
              <tr>
                ...
                <td align="right">{{ number_format($row->emp_joining_salary,2) }}</td>
                <td align="right">{{ number_format($row->emp_present_salary,2) }}</td> 
              </tr> 
