    ...
    <div class="col-md-12">
      ...
      <table class="table table-striped table-view">
        <thead class="thead-blue">
          ...
          <th  style="display:none;" class="text-center" scope="col">Weekend Id</th> 
        </thead>
        ...
        <tbody>
          ...
          <?php $row = (object) $row; ?>
            ...
            <td width="8%"><input style="width:100%" type="number" name="previousDays" value="{{ $row->previousDays }}"></td>
            ...
            <td style="display:none;"><input id="weekendValueId" value="{{ $row->weekendValueId }}"> </td>
  ...
  $('.submit-btn').click(function(){
    ...
    table.find('tr').each(function (i, el) {
      ...
      data.push({
        ...
        'previousDays' :  $tds.eq(13).find('input').val(),
        ...
        'weekendValueId': $tds.eq(17).find('input').val(),
      })
    });
