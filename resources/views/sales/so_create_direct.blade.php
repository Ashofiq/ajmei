...
<div class="title">
  <div  style="background-color:#e0e0e0" class="widget-header widget-header-small">
    ...
    <font size="2" color="blue"><b>Direct Sales (Raw Metarials, Scrape, Wastage )</b></font>
    </h6>
    <div class="widget-toolbar">
      <a href="{{route('sales.order.direct')}}" class="blue"><i class="fa fa-list"></i> List</a>
    </div>
  </div>
</div>
...
@endif
    <div class="widget-body">
      <div class="widget-main">
        <form id="so_Form" action="{{route('sales.order.direct.store')}}" method="post">
        {{ csrf_field() }}
        <div class="row">
          <div class="col-md-3">
                 ...
                 <div class="row">
                   ...
                   <tbody class="salesTable" style="background-color: #ffffff;">
                     <tr>
                      ...
                      <!-- <td width="18%">
                        <input type="text" onkeydown="enter(this.id,this.value)" data-type="newItemName" name="newItemName[]" id="newItemName_1" class="form-control" autocomplete="off" >
                      </td> -->
...
function row_increment() {
    ...
    // html += '<td width="18%"><input onkeydown="enter(this.id,this.value)" type="text" data-type="newItemName" name="newItemName[]" id="newItemName_' + i + '" class="form-control" autocomplete="off"></td>';
