  ...
  <div class="title">
    <div  style="background-color:#e0e0e0;" class="widget-header widget-header-small">
      ...
      <h6 class="widget-title smaller">
        <font size="3" color="blue"><b>Invoice Wise Profit & Loss Report</b></font>
      </h6>
    </div>
  </div>
<div class="container">
<form action="{{route('rpt.inv.wise.profit_loss')}}" method="POST">
  {{ csrf_field() }}
  ...
  <div class="row justify-content-center">
    <div class="col-md-12">
      <table style='font-size:80%' class="table table-striped table-data table-view" width="100%">
