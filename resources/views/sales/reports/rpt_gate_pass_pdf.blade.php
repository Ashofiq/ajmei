                ...
                <header>
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td align="center" valign="top" style="width:25%; "><p style="font-size: 20px; text-align: center; font-weight: bold">Gate Pass</p></td>
                            <td valign="top" style="width:25%; "></td>
                        </tr>
                ...
                <div>
                    ...
                    <table width="100%" style="font-family: serif; margin-top:-10px;" cellpadding="10">
                        <tr>
                            ...
                            <td width="20%" style="border: 0.1mm solid #888888; float: right">
                                <span style="width: 200px">Gate Pass No :</span> {{ $rows_m->del_no }}<br/> 
                                <span style="width: 200px">Date :</span> {{ date('d/m/Y') }}<br/>
