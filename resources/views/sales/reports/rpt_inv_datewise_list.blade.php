  ...
  <div class="title">
    <div  style="background-color:#e0e0e0;" class="widget-header widget-header-small">
      ...
      <h6 class="widget-title smaller">
        <font size="3" color="blue"><b>Date Wise Sales Report</b></font>
      </h6>
    </div>
  </div>
<div class="container">
<form action="{{route('rpt.inv.date.list')}}" method="POST">
  {{ csrf_field() }}
  <div class="row justify-content-center">
    ...
    <div class="col-md-2">
        ...
        &nbsp;
        <button type="submit" name="submit" value='pdf' formtarget="_blank" target="_blank" class="btn btn-sm btn-info"><span class="fa fa-search">PDF</span></button>
    </div>
  </div>
  </form>
