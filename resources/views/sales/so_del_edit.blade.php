...
<div class="title">
  <div  style="background-color:#e0e0e0" class="widget-header widget-header-small">
    ...
    <font size="2" color="blue"><b>Edit:Sales Order To Delivery</b></font>
    </h6>
...
@endif
  <form id="so_Form" action="{{route('sales.order.delivery.update')}}" method="post">
    {{ csrf_field() }}
       ...
       <div class="row">
          ...
          <div class="col-md-4">
            <div class="input-group ss-item-required">
              ...
              <div class="input-group-text" style="min-width:80px">AACustomer Disc(%):&nbsp;</div>
...
<script>
  ...
  document.getElementById('btn1').onclick = function() {
    form.action = '{{route("sales.order.delivery.update")}}';
    if(formcheck()){
      form.submit();
    }
  }
