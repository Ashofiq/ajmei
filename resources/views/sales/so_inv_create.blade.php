...
<div class="title">
  <div  style="background-color:#e0e0e0" class="widget-header widget-header-small">
    ...
    <font size="2" color="blue"><b>Sales Order To invoice</b></font>
    </h6>
...
@endif
    <div class="widget-body">
      <div class="widget-main">
        <form id="so_Form" action="{{route('sales.order.store1')}}" method="post">
        {{ csrf_field() }}
       ...
       <div class="row">
        ...
        <div class="col-md-4">
          <div class="input-group ss-item-required">
            ...
            &nbsp;<div class="input-group-text" style="min-width:80px">SP Comm(%):&nbsp;</div>
            <input type="text" size="15" name="result_cust_comm" id="result_cust_comm" value="0" class="form-control" readonly/>
          </div>
        </div>
      </div><br/>
...
document.getElementById('btn1').onclick = function() {
  form.action = '{{route("sales.order.store1")}}';
  if(formcheck()){
    form.submit();
  }
}
