...
<div class="title">
  <div  style="background-color:#e0e0e0" class="widget-header widget-header-small">
    ...
    <font size="2" color="blue"><b>Raw Materials Stock Receive Form</b></font>
    </h6>
...
@endif
  <form id="inv_Form" action="{{route('raw.itm.receive.store')}}" method="post">
    {{ csrf_field() }}
            ...
            <div class="input-group ss-item-required">
              <select name="supplier_id" id="supplier_id" class="chosen-select"  onchange="getSupplierDetails(this.value)">
                  ...
                  @foreach($suppliers as $supplier)
                      <option {{ old('supplier_id') == $supplier->id ? 'selected' : '' }} value="{{ $supplier->id }}">AJS-000{{ $supplier->id }} -> {{ $supplier->supp_name }}</option>
                  @endforeach
              </select>
              @error('supplier_id')
              ...
              <div class="row">
               ...
               <div class="container row">
                  <div class="mb-3">
                      ...
                      <input type="hidden" name="multiImage" class="form-control multiImage">
