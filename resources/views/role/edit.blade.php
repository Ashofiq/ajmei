...
@section('content')
    ...
    <div class="page-header">
        ...
        <h1 style="font-size: 18px;">
            <i class="fa fa-road"></i> Edit Role
                ...
                <div class="widget-box widget-color-blue2 ui-sortable-handle" id="widget-box-7" style="opacity: 1;">
                    <div class="widget-header widget-header-small">
                        ...
                        <div class="widget-toolbar">
                            <a href="{{route('role.index')}}" class="white"><i class="fa fa-list"></i> List</a>
                        </div>

                    </div>
                    <form action="{{route('role.update', $role)}}" method="post" class="form-horizontal">
                        @csrf
                        @method('PUT')
                                                ...
                                                <div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-xs-12 col-sm-3">
                                                            <input type="text" class="form-control input-sm date" autocomplete="off" name="name" value="{{ $role->name  }}">
                                                            @error('name')
