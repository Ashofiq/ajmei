  ...
  <div class="title">
    ...
    <div class="widget-header widget-header-small">
        <h6 class="widget-title smaller">
          <font size="3" color="blue"><b>Pending Receiving List</b></font>
        </h6>
       <div class="widget-toolbar">
         <a href="{{route('itm.inv.received.index')}}" class="blue"><i class="fa fa-list"></i> Received List</a>
        </div>
    </div></legend>
  </div>
<div class="container">
          ...
          <tr>
            ...
            <td>
                <div class="btn-group btn-corner">
                  ...
                  <a href="{{ route('itm.inv.received.create',$row->id) }}" class="btn btn-xs">Make Receive</a>
