...
<input type="hidden" name="menu_selection" id="menu_selection" value="MM@1" class="form-control" required>
  <div class="col-sm-6">
    <dl id="dt-list-1" class="dl-horizontal">
      <dt>Date:</dt><dd>&nbsp;{{ date('d-m-Y',strtotime($rows_m->rec_date)) }}</dd>
      <dt>Comments:</dt><dd>&nbsp;{{ $rows_m->rec_comments }}</dd>
    </dl>
  </div>
  <div class="col-sm-6">
    <dl id="dt-list-1" class="dl-horizontal">
      <dt>Total Qty:</dt><dd>&nbsp;{{ $rows_m->rec_total_qty }}</dd>
      ...
      <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
              ...
              <td>{{ $p_details->rec_item_remarks }}</td>
              <td align="center">{{ $p_details->rec_lot_no }}</td>
              <td align="right">{{ $p_details->rec_item_qty }}</td>
            </tr>
          @endforeach
        </tbody>
      </table>
