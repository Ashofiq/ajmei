...
<div class="title">
  <div  style="background-color:#e0e0e0" class="widget-header widget-header-small">
    ...
    <font size="2" color="blue"><b>Inventory Process Loss Form</b></font>
    </h6>
...
@endif
  <form id="inv_Form" action="{{route('itm.inv.exp.store')}}" method="post">
    {{ csrf_field() }}
         ...
         <div class="row">
          <div class="col-md-3">
            <div class="input-group ss-item-required">
                ...
                <input type="text" size = "15" name="exp_date" onclick="displayDatePicker('exp_date');"  value={{ date('d-m-Y',strtotime($exp_date)) }} />
                 ...
                 <div class="row">
                   ...
                   <table id="salesTable" class="table table-striped table-data table-view">
                     ...
                     <tr>
                       ...
                       <td width="18%"><input type="text" data-type="ItemDesc" name="ItemDesc[]" id="ItemDesc_1" class="form-control" autocomplete="off" ></td>
                       ...
                       <td width="6%" align="center" ><input type="text" data-type="Stock" name="Stock[]" id="Stock_1"  class="form-control input-sm" style="font-weight:bold; text-align: center;" autocomplete="off" readonly></td>
                       ...
                       <td width="6%" align="center"><input type="text" data-type="Rate" name="Rate[]" id="Rate_1" class="form-control input-sm changesNo iRate" onkeydown="enter(this.id,this.value)" style="font-weight:bold; text-align: center;" class="form-control input-sm" autocomplete="off" ></td>
...
//     }
//     //alert(el+' '+itemid)
//     //alert('get-item-code/getdetails/'+itemid+'/getfirst');
//     //alert('get-stock-inf/'+storgae_id+'/'+itemid+'/101/getfirst');
//     $.get('get-stock-inf/'+storgae_id+'/'+itemid+'/101/getfirst', function(data){ 
//     item = data.data
//     }).then(function(){
//       id_arr = el
//       id = id_arr.split("_")
