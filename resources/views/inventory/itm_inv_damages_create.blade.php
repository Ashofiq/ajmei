...
<div class="title">
  <div  style="background-color:#e0e0e0" class="widget-header widget-header-small">
    ...
    <font size="2" color="blue"><b>Inventory Damages Form</b></font>
    </h6>
...
@endif
  <form id="inv_Form" action="{{route('itm.inv.dam.store')}}" method="post">
    {{ csrf_field() }}
         ...
         <div class="row">
          <div class="col-md-3">
            <div class="input-group ss-item-required">
                ...
                <input type="text" size = "15" name="dam_date" onclick="displayDatePicker('dam_date');"  value={{ date('d-m-Y',strtotime($dam_date)) }} />
