  ...
  <div class="title">
    <div  style="background-color:#e0e0e0;" class="widget-header widget-header-small">
      <h6 class="widget-title smaller">
        <font size="3" color="blue"><b>Item Wise Purchase Report</b></font>
      </h6>
    </div>
  </div>
  <div class="container">
    <form id='myform' action="{{route('itm.wise.purchase.rpt')}}" id="acc_form" method="post">
      {{ csrf_field() }}
          ...
          <table class="table table-striped table-data table-report">
            ...
            <tbody>
              ...
              <tr>
                ...
                <!-- <td align="center">{{ $row->raw_order_date }}</td> -->
