<body>
  ...
  <div id="invoice" class="effect2">
    ...
    <div id="invoice-top">
      ...
      <div id="invoice-mid">   
        <div id="message">
          <h3 style="text-align: center;text-decoration: underline;">{{ $sectionData['unitName'] }}  Labour Wages Sheet ( {{ $sectionData['sectionName']  }})</h3>
        </div>
      </div>
        ...
        <table class="table-main"  style="page-break-inside:always">
          ...
          <thead>    
              <tr class="tabletitle">
                ...
                <th align="center"><h3> <center> Wages  <center></h3></th>
                <th align="center"><h3> <center> Attn. </center> </h3></th>
                <th align="center"><h3> <center>  Absent  </center></h3></th>
                <th align="center"><h3> <center> Duty Time  </center></h3></th>
                <th align="center"><h3> <center> Over Time </center></h3></th>
                <th align="center"><h3> <center> Attn. Bonus </center></h3></th>
                <th align="center"><h3> <center> Adv. Deduct </center></h3></th>
                <th align="center"><h3> <center> Total Wages </center></h3></th>
                <th align="center"><h3> <center> Signature </center> </h3></th>
                <th align="center"><h3> <center> Remarks </center> </h3></th>
              </tr>
          </thead>
          <tbody>
          <?php 
          ...
          @foreach($section['empdata'] as $row) 
            <tr class="list-item">
              ...
              <td align="center" data-label="Description" class="tableitem" width="11%">{{ $row['designation'] }}</td>
              <td align="center" data-label="Quantity" class="tableitem" width="5%">{{ $row['cartNo'] }}</td>
              <td align="center" data-label="Unit Price" class="tableitem" width="5%">{{ $row['wages'] }}</td>
              ...
              <td align="center" data-label="AWT" class="tableitem">{{ $row['attnBonus'] }}</td>
              ...
              <td align="center" data-label="AWT" class="tableitem" width="8%"> </td>
              <td align="center" data-label="Total" class="tableitem" width="8%"> </td>
            </tr>
            ...
            <?php  if(in_array($i, $index)){  ?> 
              ...
              <tr class="list-item total-row" style="border: 1px solid black">
                ...
                <td data-label="AWT" class="tableitem" style="border: 1px solid black"> {{ $section['pageAttnBonus'] }} </td>
            ...
            @if($i == $totalCount)
              ...
              @if(!in_array($totalCount, $index))
                <tr class="list-item total-row" style="border: 1px solid black">
                    ...
                    <td data-label="Quantity" class="tableitem" width="7%"> </td>
                    <td data-label="Unit Price" class="tableitem" width="7%"> </td>
                    <td data-label="Taxable Amount" class="tableitem" width="7%"> </td>
                    <td data-label="Tax Code" class="tableitem" width="8%">Page Total </td>
                    <td data-label="%" class="tableitem" width="7%" style="border: 1px solid black"> {{ $section['pageDutyTime'] }} </td>
                    <td data-label="Tax Amount" class="tableitem" width="7%" style="border: 1px solid black">{{ $section['pageOtTime'] }} </td>
                    <td data-label="AWT" class="tableitem" style="border: 1px solid black"> {{ $section['pageAttnBonus'] }} </td>
                    <td data-label="Total" class="tableitem" width="7%" style="border: 1px solid black">  {{ $section['pageTotal']  }} </td>
              ...
              <tr class="list-item total-row" style="border: 1px solid black">
                ...
                <td data-label="Unit Price" class="tableitem" width="7%"> </td>
                <td data-label="Taxable Amount" class="tableitem" width="7%"> </td>
                <td data-label="Tax Code" class="tableitem" width="8%">Grand Total </td>
                ...
                <td data-label="AWT" class="tableitem" style="border: 1px solid black">{{ $sectionData['totalAttnBonus'] }}</td>
