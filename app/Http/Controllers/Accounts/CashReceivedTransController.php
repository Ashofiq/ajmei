...
class CashReceivedTransController extends Controller
{

  public $trans_type = 3;
  public $title = 'Cash Received';
  ...
  public function cr_search(Request $request)
  {
    $trans_type = $this->trans_type;
    $title = $this->title;
  ...
  public function cr_create(Request $request)
  {
      ...
      $accTransactionId = $accTransactionId->id;
      // get requested action
      return view('/accounts/acctrans_create',
      compact('title','accTransactionId', 'trans_type','trans_date','companies','accdoctype','company_code','voucher_no','finan_year'));
  }

  public function cr_modal_view($id)
  {
      $acctranscontroller = new AccountTransController();
