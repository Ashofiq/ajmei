...
class ContraTransController extends Controller
{

  public $trans_type = 2;
  public $title = 'Contra Voucher';
  public function con_index(Request $request)
  {
  ...
  public function con_search(Request $request)
  {
    $trans_type = $this->trans_type;
    $title = $this->title;
  ...
  public function con_create(Request $request)
  {
  ...
  public function con_modal_view($id)
  {
      $acctranscontroller = new AccountTransController();
