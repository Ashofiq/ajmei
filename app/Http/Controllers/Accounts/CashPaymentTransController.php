...
class CashPaymentTransController extends Controller
{

  public $trans_type = 4;
  public $title = 'Cash Payment';
  public function cp_index(Request $request)
  {
  ...
  public function cp_search(Request $request)
  {
    $trans_type = $this->trans_type;
    $title = $this->title;
  ...
  public function cp_modal_view($id)
  {
      $acctranscontroller = new AccountTransController();
