...
class BankPaymentTransController extends Controller
{

  public $trans_type = 6;
  public $title = 'Bank Payment';
  public function bp_index(Request $request)
  {
  ...
  public function bp_search(Request $request)
  {
    $trans_type = $this->trans_type;
    $title = $this->title;
  ...
  public function bp_modal_view($id)
  {
      $acctranscontroller = new AccountTransController();
